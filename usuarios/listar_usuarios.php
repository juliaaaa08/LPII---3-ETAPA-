        ...
        ?>
                <div class="row text-center p-1">
                    ...
                    <div class="col-2 icones"> 
                        <a href="ver_usuario.php?id=<?php echo $login?>"><img src="../img/ver.png" style="width: 1.3rem;"></a> 
                        <a href="editar_usuario.php?id=<?php echo $login?>"><img src="../img/editar.png" style="width: 1.3rem;"></a>
                        <a href="excluir_usuario.php?id=<?php echo $login?>" onclick="return confirm('Confirma a Exclusão do Registro?')" ><img src="../img/delete.png" style="width: 1.3rem;"></a>
                    </div>
                </div>
        <?php
            }
